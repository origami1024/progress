...
let imgs
  ElementMonitor = (function() {
    function ElementMonitor(options) {
      ...
      for (let iterator = 0, len = imgs.length; iterator<len; iterator++ ){
        this.elements.push(new ElementTracker('premade-' + iterator))
      }
      console.log('cp1',this.elements)
    }
  ...
  ElementTracker = (function() {
    function ElementTracker(selector) {
      ...
      this.progress = 0;
      if (selector.includes('premade-')) {
        
        let tmp = selector.slice(8)
        //console.log('ss',tmp)
        imgs[tmp].addEventListener('load',e=>{
